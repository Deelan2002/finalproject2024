            ...
            <tbody>
                <?php while ($row = $result->fetch_assoc()): ?>
                    <tr>
                        ...
                        <td>
                            <a href="admin_view_skill.php?id=<?= $row['student_id'] ?>" class="btn btn-info btn-sm">View</a>
                            <a href="admin_edit_student.php?id=<?= $row['student_id'] ?>" class="btn btn-warning btn-sm">Edit</a>
